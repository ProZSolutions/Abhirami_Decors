...
public class LeaveDropDown extends SQLiteOpenHelper {
    public static final String DB_NAME="LeaveDropDown";
    public static final String DB_Table_name="LeaveDropDown";
    public static  final String ID="id";
    public static  final String Name="Name";
    public static  final String Type_value="type_value";

    public LeaveDropDown(Context context) {
