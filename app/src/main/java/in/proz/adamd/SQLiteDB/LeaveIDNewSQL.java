...
public class LeaveIDNewSQL extends SQLiteOpenHelper {
    public static final String DB_NAME="LeaveIDNewSQL";
    public static final String DB_Table_name="LeaveIDNewSQL";
    public static  final String ID="nid";
    public static final String Position="position";
    public LeaveIDNewSQL(Context context) {
