...
public class WeekOffSQL extends SQLiteOpenHelper {
    public static final String DB_NAME="WeekOffSQL";
    public static final String DB_Table_name="WeekOffSQL";
    public static  final String ID="nid";
    public static final String Position="position";
    public WeekOffSQL(Context context) {
