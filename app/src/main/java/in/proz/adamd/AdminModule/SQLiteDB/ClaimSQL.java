...
public class ClaimSQL extends SQLiteOpenHelper {
    public static final String DB_NAME="ClaimSQL";
    public static final String DB_Table_name="ClaimSQL";
    public static  final String ID="nid";
    public static final String Position="position";
    public ClaimSQL(Context context) {
