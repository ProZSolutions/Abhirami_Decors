...
public class OnDutySQL extends SQLiteOpenHelper {
    public static final String DB_NAME="OnDutySQL";
    public static final String DB_Table_name="OnDutySQL";
    public static  final String ID="nid";
    public static final String Position="position";
    public OnDutySQL(Context context) {
