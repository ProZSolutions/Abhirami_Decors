...
public class OverTimeSQL extends SQLiteOpenHelper {
    public static final String DB_NAME="OverTimeSQL";
    public static final String DB_Table_name="OverTimeSQL";
    public static  final String ID="nid";
    public static final String Position="position";
    public OverTimeSQL(Context context) {
